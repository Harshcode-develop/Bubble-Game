          ...
          <div className="w-full bg-white/80 backdrop-blur-sm border border-gray-200 rounded-2xl p-4 md:p-6 shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              <button
                ...
                className="px-3 py-3 bg-gray-100 hover:bg-gray-200 rounded-xl transition-colors border border-gray-200 hover:border-gray-300 text-black flex flex-row items-center justify-between"
              >
                <span className="text-sm font-bold">Round 1</span>
                <span className="text-[10px] text-gray-500">15 Rounds</span>
              </button>
              <button
                onClick={() => startGame("PRACTICE_20", "Hard")}
                className="px-3 py-3 bg-gray-100 hover:bg-gray-200 rounded-xl transition-colors border border-gray-200 hover:border-gray-300 text-black flex flex-row items-center justify-between"
              >
                <span className="text-sm font-bold">Round 2</span>
                <span className="text-[10px] text-gray-500">20 Rounds</span>
              </button>
            </div>
          </div>
        </motion.div>
