...
export const MainMenu: React.FC = () => {
  ...
  return (
    <GameLayout>
      <div className="flex flex-col items-center justify-center space-y-12 text-center z-10">
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
        >
          <h1 className="text-5xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-linear-to-r from-blue-600 to-emerald-600 mb-4">
            Math Bubble
          </h1>
        ...
        >
          ...
          <button
            ...
            className="group relative w-full px-8 py-5 bg-black text-white border border-gray-900 rounded-2xl shadow-xl hover:bg-gray-800 transition-all duration-300 flex items-center justify-center overflow-hidden"
          >
            <Trophy className="mr-3 w-6 h-6 text-yellow-400" />
            <span className="text-xl font-bold tracking-wider">START GAME</span>
          ...
          <button
            ...
            className="w-full py-3 bg-white border border-gray-200 rounded-xl shadow-sm hover:bg-gray-50 flex items-center justify-center text-gray-600 font-medium transition-colors"
          >
            <RefreshCw
              id="shuffle-btn-icon"
          ...
          {/* Practice Section */}
          <div className="w-full bg-white/80 backdrop-blur-sm border border-gray-200 rounded-2xl p-6 shadow-lg">
            <h3 className="text-gray-600 font-semibold mb-4 flex items-center justify-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className="px-4 py-3 bg-gray-100 hover:bg-gray-200 rounded-xl transition-colors border border-gray-200 hover:border-gray-300 text-black"
              >
                <div className="text-lg font-bold">Round 1</div>
              ...
              <button
                ...
                className="px-4 py-3 bg-gray-100 hover:bg-gray-200 rounded-xl transition-colors border border-gray-200 hover:border-gray-300 text-black"
              >
                <div className="text-lg font-bold">Round 2</div>
